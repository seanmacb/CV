...
$\bullet$ Multi-Messenger Astrophysics             & $\bullet$ Systems Design for Astronomy            
\end{tabular}
\end{center}
\end{rSection}
...
\textit{Rubin Observatory Project Team}: Led \ac{LSSTCam} focal plane commissioning to Rubin Observatory in Cerro-Pachón in Chile, from receipt on summit through early science operations, including testing of the focal plane in-laboratory and on-telescope. Characterized defects in the \ac{LSSTCam} focal plane CCDs. Developed custom image processing tool to monitor the stability of defects in the \ac{LSSTCam} focal plane. Led the \ac{ToO} observing program during Rubin early operations.

\textit{\ac{lsst} \ac{desc}}: Forecasted the constraining power of dark sirens using simulated \ac{lsst} data under different conditions. Leading a dark-siren analysis using \ac{lsst} commissioning data (Data-Preview 2) and public data from the International Gravitational Wave Network (IGWN), the first dark siren detection using \ac{lsst} data.
\end{rSubsection}
...
\begin{rSubsection}{\ac{des}}{2023 - Present}{}{}
Performed observations, image processing, and analysis of images from \ac{DECam} observations in response to \ac{GW} triggers from the International Gravitational Wave Network (IGWN) \ac{O4} for the \ac{desgw} observing program. Implemented improvements to \ac{desgw} alert and image processing pipelines, including improvements to the telescope strategy and real-time alert monitoring. Led collaboration between the \ac{J-GEM} and \ac{desgw} through joint observations of \ac{GW} event S250328ae using \ac{DECam} and the \ac{PFS} at Subaru Observatory.
...
\begin{rSubsection}{\ac{LLAMAS}}{2020 - 2022}{}{}
Assembled and modified opto-mechanical mounts and ground support equipment for the \ac{LLAMAS} instrument, including verification of mechanical tolerance for custom-fabricated parts using a coordinate measurement machine. Verified spectrograph grating efficiency through optical tests, and integrated the spectrograph camera lenses into their bezels for the 24 camera spectrograph. Integrated the 2,400 AR-coated fibers to the spectrograph by bonding with optical adhesive, with 100\% accuracy and zero fiber loss.
\end{rSubsection}
...
%     \setlength{\extrarowheight}{3pt} 
% \begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
%         2025 & GW-Primo. PI: McMahon, Co-I: MacBride. 2 nights. \\
%         2023 - 2027 & DESGW. PI: Soares-Santos, Co-I: MacBride. 4 nights every semester (6 months).
%     \end{tabular}
%     \end{table}
% \end{rSection}
...
\begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
     ...
     2024 - 2027 & \ac{LSSTCam} Summit Support Scientist \\
     2022 - 2024 & Elected member, University of Michigan Physics Graduate Council \\
     2022 - 2024 & Member, University of Michigan Physics DEI committee \\
     2022 - 2024 & Member, University of Michigan APS chapter \\
     2016 - 2020 & Member and peer advisor for the Wheaton College physics club
\end{tabular}
\end{table}
\end{rSection}
...
\begin{table}[h]
    \setlength{\extrarowheight}{3pt} 
\begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
2026 & Graduate Instructor, Introduction to Scientific Computing, University of Zürich\\
2025 & Graduate Instructor, Introduction to Astroparticle Physics, University of Zürich\\
2023-2024 & Lead Graduate Instructor, Introductory Physics for Life Sciences, University of Michigan-Ann Arbor\\
2022-2023 & Graduate Instructor, Introductory Physics for Life Sciences, University of Michigan-Ann Arbor\\
2018-2019 & Undergraduate Teaching Assistant, Introductory Physics, Wheaton College, MA\\
\end{tabular}
\end{table}    
\end{rSection}
...
\begin{table}[h]
    \setlength{\extrarowheight}{3pt} 
\begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
     2025 &  EAS Annual Meeting Special Session 27: The Rubin Observatory Legacy Survey of Space and Time: from Data Previews to Full Survey Operations \\
     2024 &  Conferences for Undergraduate Women in Physics (CUWiP) 2024 \\
     2023 &  DESI Collaboration Meeting, LOC \\
     2023 & University of Michigan-Ann Arbor Physics Graduate Student Symposium
\end{tabular}
\end{table}
\end{rSection}
\newpage
...
\begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
    ...
    2023-2024 & Elise Kesler: Undergraduate student at University of Michigan-Ann Arbor. Current physics PhD student at CU Boulder.\\
...
\begin{table}[h]
    \setlength{\extrarowheight}{3pt} 
\begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
07/2026 & Plenary Talk, Rubin Community Workshop 2026, SLAC National Accelerator Laboratory\\
...
02/2025 & \href{https://docs.google.com/presentation/d/18RmTzV5id9RSE4_1xui-RJvK5FeGknrt8Ro1nBn32nk/edit?usp=sharing}{Plenary Talk, DESC Collaboration meeting}\\
