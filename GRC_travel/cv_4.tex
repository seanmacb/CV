...
\begin{rSubsection}{University of Zürich}{Apr 2023 - Present}{Ph.D Student}{Prof. Marcelle Soares-Santos}
    ...
    \begin{itemize}
        \item Led a study of galaxy catalog completeness on dark siren analysis consequences. Obtained a 2.5M CPU-hour computing grant from the National Energy Research Scientific Computing Center to support this research. Expected publication mid 2026.
...
\begin{rSubsection}{University of Zürich Physics Department}{Aug 2025 - Present}{Graduate Student Instructor}{Zürich, CH}
    \item Led weekly exercise sessions with $\sim15$ masters level students to explore fundamental cosmology principles. 
    \item Filled knowledge gaps with students who required additional support through one-on-one exercises and individualized activities.
\end{rSubsection}
...
\begin{itemize}
    ...
    \item Tim Fanning: Previous undergraduate student. Current Physics PhD student at Indiana University Bloomington.
\end{itemize}
\end{rSubsection}
