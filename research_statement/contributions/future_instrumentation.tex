...
In the \LSST\ era, the central bottleneck will not be imaging depth, but rather spectroscopic capacity: both dark and bright siren measurements ultimately require secure redshifts of host galaxies and rapid characterization of transients from \LSST's alert stream. To aid this effort, I will test and deploy advanced focal plane technology for future multi-object spectrographs.
...
Building on my commissioning-era characterization of focal-plane defects, I will deploy a defect-monitoring tool, currently in-development, to \texttt{cp\_verify}, the calibration-product verification framework used by the \LSST\ Science Pipelines \cite{10.71929/rubin/2570545}. Elevating this tool to a published resource will transition defect monitoring to an automated process, directly improving the quality of \LSST\ data.