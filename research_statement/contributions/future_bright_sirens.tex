...
% Rubin ToO - drafted
I will lead the observing planning, execution, and analysis of the next bright standard siren accessible to \Rubin, along with 
...
\end{wrapfigure}
other \ToO's pursued during the \LSST, continuing my role as the \Rubin\ \ToO\ observer throughout the transition to operations.
...
While it is difficult to predict the timing of the next bright siren, I will continue to deploy improvements to the \ToO\ system to improve response latency, observing strategy, and automation, to maximize the forthcoming opportunity to detect and characterize these optical counterparts to obtain a well-constrained measure of \Ho.
...
As the \ToO\ program matures, I will work to enhance counterpart characterization by securing spectroscopic follow-up time on other instruments, moving beyond photometric classification to confirm spectral features that can inform the scope of \Rubin's \ToO s and constrain the physical properties of the \LSST\ transients.% and their host environments. 
