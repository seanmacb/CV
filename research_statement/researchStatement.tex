...
\begin{tcolorbox}[
  ...
  \begin{itemize}[noitemsep, topsep=0pt, leftmargin=1em]
    \item Commissioning the focal plane array of LSST-Camera, and testing and integrating multi-object and integral-field spectroscopic instruments.
    \item Leading searches for electromagnetic counterparts to gravitational wave mergers using Vera C. Rubin Observatory, and other observing campaigns using both photometric and spectroscopic instruments.
...
\begin{tcolorbox}[
  ...
  \begin{itemize}[noitemsep, topsep=0pt, leftmargin=1.2em]
    \item Develop future astronomical instruments, focusing on multi-object spectroscopy, and deploy monitoring tools for LSST-Camera.
  ...
  \end{itemize}
\end{tcolorbox}
At \Institute, I will build directly on my research in instrumentation, multi-messenger astrophysics, and standard siren cosmology, to 
