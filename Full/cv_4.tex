...
\begin{rSubsection}{University of Zürich/University of Michigan}{Apr 2023 - Present}{Ph.D Student}{Prof. Marcelle Soares-Santos}
    ...
    \item \textbf{Rubin Observatory}: Led verification, integration, and testing of LSST Camera (LSSTCam) to the Rubin Observatory on Cerro-Pachón in Chile. Characterized defects in LSSTCam, including the picture-frame response in different detector types and vampire pixels. Contributed to commissioning telescope mount assembly. Contributed to Target-of-Opportunity strategy development for GW, neutrino, and solar system object events. 
...
Below are selected publications from different collaborations and projects I have contributed to. A full list of my publications can be found on my \href{https://scholar.google.com/citations?user=XtRTswUAAAAJ&hl=en}{Google Scholar profile}.
