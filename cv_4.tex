...
\item Tested the efficiency of diffractive gratings at nominal orientation. Modified existing test equipment to measure blaze-angle transmission. Authored report detailing procedure, methods, results, and analysis.
\item Prepared industrial adhesives for bonding handling tabs to optical components. Developed and modified bonding proceure to best accomodate changing circumstances. Successfully handled high pressure environments, resolving problems and eliminating risk of potential damage to optical components.
...
\item Loaded and unloaded optical fibers into anti-reflective coating fixtures. Integrated the AR-coated fibers to the spectrograph by bonding with optical adhesive. Authored and modified the fiber bonding and protective tube-pulling procedure to meet evolving science and safety needs.
% \item SPEXS STUFF?
