...
\begin{rSection}{Education}
    \begin{rSubsection}
        {University of Zürich - Zürich, Switzerland}{May 2024 - 2027}{Ph.D. in Physics}{}
        
        Thesis title: \textit{Standard Siren Cosmology: From Instrumentation to Inference}
    \end{rSubsection}
    
    \begin{rSubsection}
        {University of Michigan - Ann Arbor, Michigan, USA}{Aug 2022 - May 2024}{M.Sc. in Physics}{}
    \end{rSubsection}
...
% \end{tabular}
\begin{rSubsection}{Wheaton College - Norton, Massachusetts, USA}{Aug 2016 - May 2020}{B.A. in Physics with Honors. Minor in Astronomy}{}
...
\begin{rSubsection}{University of Zürich\footnote{In 2024, the Soares-Santos research group moved from the University of Michigan-Ann Arbor to the University of Zurich.}}{Apr 2023 - Present}{Ph.D Student}{Prof. Marcelle Soares-Santos}

    \item \textbf{Rubin Observatory:} \ac{LSSTCam} Summit Support Scientist, \ac{ToO} Coordinator.
    \begin{itemize}
        \item Led \ac{LSSTCam} focal plane commissioning to Rubin Observatory in Cerro-Pachón in Chile, from receipt on summit through early science operations, including testing of the focal plane in-laboratory and on-telescope.
        \item Characterized defects in the \ac{LSSTCam} focal plane, including transient CCD surface defects, picture-frame response in different detector types, and transient surface level effects. Developed custom image processing tool to monitor the stability of defects in the \ac{LSSTCam} focal plane.
        \item Led the \ac{ToO} observing program during Rubin early operations (May 2025 - present), including \ac{ToO} responses to \ac{GW} candidates S250725j and S251112cm.
    \end{itemize}
    \item \textbf{\ac{DESC}:} Analysis of Standard Sirens with LSST data.
    \begin{itemize}
        \item Forecasted the constraining power of dark sirens using simulated \ac{LSST} data under different conditions. Obtained a 3M CPU-hour computing grant from the \ac{NERSC} to support this research.
        \item Preparing dark-siren analysis using LSST commissioning data (Data-Preview 2) and public data from the LIGO-Virgo-KAGRA collaboration, the first dark siren measurement using LSST.
    \end{itemize}
     \item \textbf{\ac{DES}:} \ac{DECam} Image Processing and Analysis, Partnership with Subaru Scientists.
     \begin{itemize}
         \item Implemented improvements to \ac{desgw} alert and image processing pipelines, including improvements to the telescope strategy and real-time alert monitoring.
         \item Performed observations, image processing, and analysis of images from \ac{DECam} observations in response to \ac{GW} triggers from \ac{igwn} \ac{O4}. 
         \item Led collaboration between the \ac{J-GEM} and \ac{desgw} through joint observations of \ac{GW} event S250328ae using \ac{DECam} and the \ac{PFS} at Subaru Observatory.
     \end{itemize}
     \item \textbf{\ac{igwn}:} $H_0$ measurements with the \ac{DELVE} and \ac{DES} galaxy catalogs, \ac{ToO} coordination with Rubin Observatory.
     \begin{itemize}
         \item Led dark siren analysis using \ac{DELVE} survey data for \ac{igwn} O4c data, including galaxy catalog preparation and systematic-uncertainty quantification.
   ...
   % \end{itemize}
    ...
    \item \textbf{Robotic Positioners:} Testing and Optimization for Multiplexed Spectroscopic Galaxy Surveys
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Successfully acquired the field of interest during occultation event. Contributed data to NASA-LUCY ground based occultation team, which confirmed 15094 Polymele's surface features and presence of a smaller orbiting satellite.
\end{itemize}
\end{rSubsection}
...
\begin{itemize}
\item Assembled and modified opto-mechanical mounts and ground support equipment for the \ac{LLAMAS} instrument, including verification of mechanical tolerance for custom-fabricated parts using a coordinate measurement machine.
\item Verified spectrograph grating efficiency through optical tests, and integrated the spectrograph camera lenses into their bezels for the 24 camera spectrograph.
\item Integrated the 2,400 AR-coated fibers to the spectrograph by bonding with optical adhesive, with 100\% accuracy and zero fiber loss.
\end{itemize}
\end{rSubsection}
...
\begin{itemize}
\item Developed an analysis pipeline to concatenate single-day solar observations. Utilized data pipeline to collect spectrophotometry from different solar events.
\item Analyzed ground-based data and data from the International Space Station to study correlations between historical S-index, magnetic activity, total solar irradiance, and spectral solar irradiance.
\item Determined limit of detection of solar events for a proposed ground-based optical spectrometer.
\end{itemize}
\end{rSubsection}
...
\begin{itemize}
\item Designed, implemented, and modified a data pipeline for use with ESA Gaia space telescope DR-2 data selections of dwarf satellite galaxies. Discovered small scale tidal tail around central core of dwarf satellite galaxy Carina using radial density measurements.
\item Prepared and delivered final presentation at summer research symposium and to professors and graduate students of the physics and astronomy department.
\end{itemize}
\end{rSubsection}
...
\item Determined specifications of diffraction grating for use with DSLR camera. Obtained spectrum of Vega and Capella using grating and a 30s exposure. Identified iron absorption features in both stars.
...
\begin{itemize}
\item Designed, built, and operated a 2.1 \& 1.06 $\mu$m laser pump source for proof of concept atmospheric-monitoring mid-infrared Lanthanide-LuAG laser.
...
\begin{rSubsection}{University of Zürich, Physics Department}{Aug 2025 - Present}{Graduate Student Instructor}{Zürich, CH}
    \item Organized course administration, including exercise development and grade tabulation for bachelors and masters physics students.
    \item Prepared guided exercises on astroparticle physics and cosmology, including lectures on structure formation, evolution of different components of an expanding universe, and other fundamental cosmology concepts.
    \item Efficiently evaluated $\sim10$ students per hour during review sessions, evaluating proficiency in scientific computing exercises for small python scripts.
\end{rSubsection}
...
\end{rSubsection}
% \newpage 
\begin{rSubsection}{Wheaton College Physics Department}{Aug 2018 - Dec 2019}{Teaching Assistant and Tutor}{Norton, MA}
    ...
    \item Performed laboratory setup and breakdown for class of 40+ students in accordance with schedule. Communicated student comprehension of specific topics to professors to increase participation.
...
\begin{rSubsection}{Rubin Observatory}{Jan 2025 - July 2025}{LSST Summit-Support Scientist}{Cerro Pachón, Chile}
    \item Provided interviews to the \href{https://youtu.be/6RBZqhIgllI?si=WJu_PTFMFdWa_h7s}{BBC}, the \href{https://www.wsj.com/science/space-astronomy/worlds-largest-digital-camera-snaps-its-first-photos-of-the-universe-68099904?mod=Searchresults_pos1&page=1}{Wall Street Journal}, \href{https://www.sciencenews.org/article/vera-rubin-observatory-digital-camera}{Science News}, and other publications regarding \ac{LSSTCam}. Led tours for media and local dignitaries to showcase LSSTCam performance, features, and known issues.
...
\begin{rSubsection}{University of Michigan-Southern Illinois University}{Aug 2023 - May 2024}{Eclipse Group Leader}{Albuquerque NM, Burlington VT}
    \item Led high school group of students to operate a solar telescope and take images of the sun during the 2023 annular eclipse and 2024 total eclipse. Prepared and delivered lectures for students about the physics of the sun, solar observations, and eclipses through virtual and in person presentations.
...
\begin{rSubsection}{Wheaton College Astronomy Department}{Aug 2016 - May 2020}{Observatory Guide}{Norton, MA}
    \item Showcased features of different telescopes to local tour groups at Wheaton College Observatory. Operate and adjust telescopes to show appropriate stars, objects, and events based on sky conditions.
...
\begin{rSubsection}{University of Zürich}{}{}{}
    \begin{itemize}
    \item Alexs Gaute: Previous Summer Student.
...
\begin{itemize}
    \item Elise Kesler: Previous undergraduate student. Current physics PhD student at CU Boulder.
    \item Tim Fanning: Previous undergraduate student. Current nuclear physics PhD student at Indiana University Bloomington.
\end{itemize}
\end{rSubsection}
...
\begin{rSection}{Professional Service}
    \begin{itemize}
        \item LSST-DESC
        \begin{itemize}
            \item Speakers Bureau Co-Chair (2026-2028)
            \item Collaboration Council Member (2026-2028)
        \end{itemize}
        \item Rubin Observatory
        \begin{itemize}
            \item LSST-Camera Summit Support Scientist (2024 - present).
            \item Target-of-Opportunity Coordinator (2025 - present).
        \end{itemize}
        \begin{itemize}
            \item Organized the Conferences for Undergraduate Women in Physics (CUWiP) 2024 at the University of Michigan-Ann Arbor.
	        ...
	        \item APS chapter member from 2022 - 2024.
        \end{itemize}
        \item Wheaton College MA
        \begin{itemize}
...
\begin{rSubsection}{Talks}{}{Entries marked with * indicate an invited talk.}{}
...
07/2026* & The Scientific Promise of the Rubin Target of Opportunity Program in the First Year of LSST Operations, Rubin Community Workshop 2026, SLAC National Accelerator Laboratory, Menlo Park, USA\\
07/2026* & The LSST Camera and its Influence on Dark Energy Science, Dark Energy School, LSST Dark Energy Science Collaboration Meeting, Paris, France\\
07/2026* & The On-Sky Performance of the LSST Camera CCD Array, SPIE Astronomical Telescopes + Instrumentation, Copenhagen, Denmark\\
07/2026 & The Rubin Target of Opportunity Program in the First Year of LSST Operations, SPIE Astronomical Telescopes + Instrumentation, Copenhagen, Denmark\\
% 06/2026 & Measurement of the Hubble Constant Using the Dark Energy Legacy Volume Explorer Data Release 3 Galaxy Catalog and the Fourth Gravitational-Wave Transient Catalog, Swiss Cosmology Days, University of Geneva, Geneva, CH\\
05/2026* & Status of the Rubin Target of Opportunity Program and Recommendations for the LVK IR1 Run, Rubin ToO 2026 Workshop, Virtual\\
04/2026* & Commissioning the LSST Camera Focal Plane Array at Rubin Observatory, KIPAC Tea, Stanford University, Menlo Park, USA\\
03/2026 & Characterization of the DECam Local Volume Exploration Survey for Standard Siren Measurement, LIGO-Virgo-KAGRA Collaboration Meeting, Pisa, Italy\\
03/2026 & Status of the Rubin Target of Opportunity Program, LIGO-Virgo-KAGRA Collaboration Meeting, Pisa, Italy\\
...
02/2025* & \href{https://docs.google.com/presentation/d/18RmTzV5id9RSE4_1xui-RJvK5FeGknrt8Ro1nBn32nk/edit?usp=sharing}{LSSTCam Performance and Readiness, DESC Collaboration meeting, Virtual}\\
